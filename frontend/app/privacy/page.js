  ...
  return (
    <LegalPageLayout title="Privacy policy" eyebrow="Your data on CivicView" lastUpdated="May 20, 2026">
      ...
      <ul>
        ...
        <li><strong>Anthropic</strong> — for AI features (bill summaries, vote explanations). We send only public bill text or vote questions; never user PII, never your comments, never your engagement history.</li>
